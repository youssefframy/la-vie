        ...
        <div className="flex justify-center items-center">
          <div className="flex flex-col justify-center items-start w-[60%] m-5 p-5">
            <div className="flex justify-between items-start w-[100%]">
                <div>
                    <h1 className="font-Poppins text-xl text-darkgray mt-4">First Name</h1>
                    <input type="text" className="lg-input" />
                </div>
                <div>
                    <h1 className="font-Poppins text-xl text-darkgray mt-4">Last Name</h1>
                    <input type="text" className="lg-input" />
                </div>
            </div>
            ...
            <h1 className="font-Poppins text-xl text-darkgray mt-4">Confirm Password</h1>
            <input type="password" className="lg-input" />
